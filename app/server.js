...
server.post('/addSong', function(req, res) {  //** MVP **//
  ...
  db.addSong(songData.title, songData.genre, songData.author, songData.authorName, songData.authorPic, songData.description, songData.url, songData.rootId, songData.parentId, function(response) {
    res.send(response);
  });
})
